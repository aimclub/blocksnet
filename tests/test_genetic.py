...
def aggregated_blocks():
    return gpd.read_parquet(os.path.join(example_data_path, "data_getter_blocks.parquet"))

@pytest.fixture
def accessibility_matrix():
    return pd.read_pickle(os.path.join(example_data_path, "data_getter_matrix.pickle"))
