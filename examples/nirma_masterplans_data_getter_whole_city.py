...
class DataGetter:
    ...
    def get_city_geometry(self, city_name, city_admin_level, dissolve=True) -> None:
        """
    ...
    #     blocks = gpd.GeoDataFrame(blocks, geometry="geometry", crs=blocks_with_buildings.crs)
